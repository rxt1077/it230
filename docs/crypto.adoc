...
For this lab we will use a simple https://github.com/rxt1077/it230/blob/main/labs/hash/crypt.c[`crypt`] utility which calls the system https://man7.org/linux/man-pages/man3/crypt.3.html[`crypt`] command and prints the output.
It is already included in the `ryantolboom/hash` image.
